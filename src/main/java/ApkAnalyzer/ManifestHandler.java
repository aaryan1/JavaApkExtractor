...
public class ManifestHandler  extends DefaultHandler {
	...
	private List<String> broadCastReceiverList = new ArrayList<String>();
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException{
		...
		if(qName.equalsIgnoreCase("uses-feature"))
		{
			featureList.add(attributes.getValue("android:name"));
			ApkManifestData.setFeaturesList(featureList);
		}
		...
		{
			broadCastReceiverList.add(attributes.getValue("android:name"));
			manifestdata.setBroadCastReceiverList(broadCastReceiverList);
